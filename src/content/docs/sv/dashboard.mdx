...
Det bör noteras att funktionerna i instrumentpanelen till stor del beror på vilken prenumerationsnivå ditt konto är under. Företagsanvändare kan t.ex. tilldela maskiner till målgrupper och skapa tysta installationsprogram. Å andra sidan kan vem som helst (inklusive personliga användare) skapa anpassade installatörer för sina obevakade maskiner.
...
Om du är en nätverksadministratör som inte har RIM installerat kan du helt enkelt logga in på ditt konto på RIM-webbplatsen så visas din instrumentpanel.

## Hantera mål

När du klickar på länken "Konfigurera mål" kommer du till en sida där du kan hantera alla de maskiner som du har konfigurerat för obevakad åtkomst. Du kan klicka på vilken som helst av dessa maskiner för att hantera den. När du är inne kommer du att kunna:
* Byta namn på målet
...
Du kan ha så många målgrupper som behövs för ditt användningsområde. 

### Åtkomstkontroll (för företagsorganisationer)

Om din organisation tilldelar en supporttekniker en specifik uppsättning maskiner vill du förmodligen se till att de bara har åtkomst till den specifika uppsättningen. Det är här inställningen för åtkomstkontroll för målgrupper kommer in i bilden.  
...
Det bör noteras att alla organisationsadministratörer automatiskt får tillgång till att hantera alla grupper som skapas under organisationen.

## Ställa in en förkonfigurerad RIM Installer (Pro eller högre)

Ett av de enklaste sätten att konfigurera en maskin för obevakade eller uppmanade anslutningar är att skapa ett anpassat installationsprogram. Detta är otroligt användbart om du konfigurerar massdistributioner, eller till och med som ett enklare sätt att få igång RIM på en slutanvändares dator som du planerar att ge support för regelbundet.
...
1. Du får sedan en kryssruta där du kan välja att få ett e-postmeddelande när en användare installerar RIM via det här installationsprogrammet.
1. Om du är en företagsadministratör kommer du att se en kryssruta som låter dig bygga installationsprogrammet som ett MSI-paket. Det här alternativet är användbart för massdistribution av ett anpassat installationsprogram till ett maskinkluster som kommer att tilldelas den givna målgruppen.
...
Nu när du har ditt installationsprogram kan det köras på ett av två sätt. I båda fallen kommer maskinen att läggas till i listan över maskiner i både ditt konto och RIM-klienten när installationsprogrammet är klart.
...
* typ av anslutning, dvs. om en prompt krävs eller inte

Användaren kan välja att antingen svara ja eller nej till installationen. Om användaren svarar nej avbryts installationen. När installationen är klar kommer användaren att få ett meddelande om att maskinen nu är konfigurerad för fjärråtkomst.
