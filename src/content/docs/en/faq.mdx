...
### What is the extent of data collected through the Scribe for Meetings bot, any uses of said collected data, and who would have access to the collected data?

The Scribe bot processes the screen contents shared by the presenter(s). That data stays within our secure network and is neither stored nor processed by any third party.
