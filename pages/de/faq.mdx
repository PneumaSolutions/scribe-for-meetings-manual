...
Hier finden Sie Antworten auf einige häufig gestellte Fragen zu RIM. Wenn Sie mit einem Problem konfrontiert werden, beziehen Sie sich bitte wann immer möglich auf dieses Dokument. Wenn Ihre Frage in diesem Dokument nicht behandelt wird, wenden Sie sich bitte an [Contact us.](https://pneumasolutions.com/contact/)
## Kompatibilität
...
Dies könnte auf einen Konflikt bei der Tastaturbelegung zurückzuführen sein. In seltenen Fällen kann es vorkommen, dass eine Tastaturbelegung, die sich stark von Ihrer eigenen unterscheidet, RIM verwirrt. Sollte dies der Fall sein, senden Sie uns bitte einen Bericht mit Informationen über die Tastaturbelegung beider Geräte.
### Ist nach der Neukonfiguration eines Computers mit demselben Computernamen noch etwas zu tun, um RIM wieder zum Laufen zu bringen? 
Entfernen Sie einfach den Computer aus Ihrem Konto, installieren Sie RIM neu und fügen Sie den Computer dann wieder Ihrem Konto hinzu.
...
Wir wickeln Zahlungen über Stripe ab, so dass wir direkt Visa, Mastercard, Amex oder Discover akzeptieren können. Außerdem kann Stripe auch Zahlungen über Google Pay akzeptieren.
### Wie funktionieren diese Pässe? Beginnt die Zeit sofort nach der Zahlung oder am Tag, an dem ich die Sitzung initiiere?
...
### Wenn ich einen unbeaufsichtigten Rechner aus meinem Controller-Konto lösche, werden dann automatisch die Berechtigungen für das Ziel entzogen?
