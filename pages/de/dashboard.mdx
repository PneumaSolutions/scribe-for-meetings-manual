...
RIM verfügt über ein webbasiertes Dashboard, das verschiedene Aufgaben der Computer- und Kontenverwaltung erleichtert. Sie können Ihre vorhandenen unbeaufsichtigten Computer verwalten, vorkonfigurierte Installationsprogramme für Zielcomputer erstellen und vieles mehr.  
...
Wenn Sie ein Controller sind, gelangen Sie am einfachsten über die Hauptschnittstelle von RIM zum Dashboard. Wenn Sie auf die Schaltfläche RIM-Dashboard klicken, wird das Dashboard automatisch in Ihrem Standardbrowser geöffnet, wobei die Anmeldung bereits erfolgt ist.  
