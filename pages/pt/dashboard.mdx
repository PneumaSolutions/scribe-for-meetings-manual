...
# O painel de gerenciamento do RIM
...
## Gerenciando alvos
Ao clicar no link "Configure Targets" (Configurar alvos), você chegará a uma página que permite gerenciar todas as máquinas que você configurou para acesso não supervisionado. Você pode clicar em qualquer uma dessas máquinas para gerenciá-la. Uma vez lá dentro, você poderá:
* Renomear o alvo
...
O usuário pode optar por responder sim ou não à instalação. Se responder não, a instalação será cancelada. Após a conclusão do instalador, o usuário receberá um aviso informando que o computador está agora configurado para acesso remoto.
