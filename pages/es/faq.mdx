...
A continuación encontrará respuestas a algunas preguntas frecuentes sobre RIM. Cuando se enfrente a un problema, consulte este documento siempre que sea posible. Si su pregunta no está cubierta en este documento, por favor [Contacte con nosotros.](https://pneumasolutions.com/contact/)
## Compatibilidad
...
### La máquina de destino a la que estoy conectado no responde correctamente a comandos de teclado que funcionan bien en mi teclado. ¿Qué ocurre?
Esto puede deberse a un conflicto en la distribución del teclado. En raras ocasiones, si una distribución de teclado es lo suficientemente diferente de la suya, puede confundir a RIM. Si esto ocurre, ponte en contacto con nosotros y envíanos un informe con información sobre la distribución del teclado de ambos equipos.
### Después de que un ordenador ha sido reimaginado y ha sido reconfigurado con el mismo nombre de ordenador, ¿hay que hacer algo para que RIM vuelva a funcionar? 
...
En la mayoría de los casos, especialmente cuando el cifrado de disco FileVault está activado, el usuario de destino deberá introducir manualmente la contraseña. RIM no puede iniciarse en un Mac cifrado antes de que se haya iniciado una sesión completa.
